...
const Ranking = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center">
      ...
      <p className="absolute top-[9%] w-full text-center text-[1.5vw] mb:text-[3.5vw] text-[#832111] font-semibold">Mỗi bảng, 05 Đại Hiệp có điểm bình chọn cao nhất sẽ tiến vào Vòng 2</p>
