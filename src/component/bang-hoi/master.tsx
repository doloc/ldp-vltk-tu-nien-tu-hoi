...
const Master = () => {
  ...
  return (
    <div className="relative overflow-hidden w-full flex flex-col items-center bg-cover bg-center bg-no-repeat aspect-[960/589] mb:aspect-[640/1060] mb:bg-[image:var(--bg-mobile-url)] bg-[image:var(--bg-pc-url)]"
      style={{'--bg-mobile-url': `url(/images/mb-hero-bg.jpg)`, '--bg-pc-url': `url(/images/bang-hoi/pc-minhchu-bg.jpg)`} as CustomStyleProperties}>

      <img src="/images/bang-hoi/title-minhchu.png" alt="" className="-mt-[2%] w-[50%]" />
      ...
      style={{'--bg-mobile-url': `url(/images/mb-hero-bg.jpg)`, '--bg-pc-url': `url(/images/bang-hoi/pc-shape-bg.png)`} as CustomStyleProperties}>
        ...
        <div className="absolute top-[15%] -right-[9%] w-[12%] flex flex-col items-start">
